...
**Project**: podcraft-generator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: A PODCAST PLATFORM THAT ALLOWS USERS TO CREATE PODCAST USING GROQ LLAMA3-8B-8192, ANTHROPIC CLAUDE SONNET 3.5, CLAUDE ANTHROPIC OPUS, ELEVANLAB, TO GENERATE FULL PODCAST SHOWS, THEN THE FINISHED PODCAST WILL BE POSTED ONTO THE FRONTEND FOR PEOPLE TO LISTEN. ADD A PODCAST LISTENING WINDOW THAT HAS "PLAY", "FASTFORWARD", ALLOW USERS TO UPLOAD PODCAST COVER ART FOR THE PODCAST. 
...
```sh
git clone https://github.com/GPT-Engineer-App/podcraft-generator.git
cd podcraft-generator
npm i
